...
# Encrypt button
button_encrypt = tk.Button(window, text="Decrypt", command=decrypt_message)
button_encrypt.pack(pady=5)
button_encrypt.bind('<Return>', lambda event: decrypt_message())  # Enter key support
...
# Key bindings
window.bind('<Return>', decrypt_message)  # Enter in text fields triggers encryption
window.bind('<KP_Enter>', decrypt_message)  # Numpad Enter
